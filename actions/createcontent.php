...
<div class="createdatasections">
	...
	<form class="" id="createcontentinputform" action="./actions/createcontent.php" method="POST">
		<div class="row">
			<div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
				<label id="labellettering">Image</label>
			</div>
			<div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
				<input type="text" name="Image" placeholder="./IMG/abcd.jpg">
			</div>
		</div>
		<div class="row">
			<div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
			...
			<div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
				<select id="labellettering" name="Locationtype">
		...
		<div class="row">
			...
			<div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
				<input type="text" name="Locationname" placeholder="Place of Interest">
			</div>
		</div>
		<div class="row">
			<div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
			...
			<div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
				<select id="labellettering" name="fk_Address_ID">
					<?php 
					require_once 'db_connect.php';
		...
		<div class="row">
			...
			<div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
				<input type="text" name="Telephone" placeholder="+7 (120) 345898989">
			</div>
		</div>
		<div class="row">
			<div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
			...
			<div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
				<input type="text" name="Webaddress" placeholder="www.aba.com">
			</div>
		</div>
		<div class="row">
			<div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
			...
			<div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
				<input type="text" name="Metrostop" placeholder="Admiralteyskaya">
			</div>
		</div>
		<div class="row">
			<div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
			...
			<div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
				<input type="text" name="OpenTimes" placeholder="12:00 - 13:00">
			</div>
		</div>
		<div class="row">
			<div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
		...
		<div class="row">
			...
			<div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
				<input type="text" name="Eventplacename" placeholder="">
			</div>
		</div>
		<div class="row">
			<div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
			...
			<div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
				<input type="text" name="Entrycost" placeholder="000 Rbl">
			</div>
		</div>
		<div class="row">
			<div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
			...
			<div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
				<input type="time" name="Eventtime" placeholder="17:00">
			</div>
		</div>
		<div class="row">
			<div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
			...
			<div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
				<input type="date" name="Eventdate" placeholder="17 Oct 2019">
			</div>
		</div>
		<div class="row">
			<div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
		...
		<div class="row">
			<div  id="labellettering" class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
				<button  class="btn btn-default" type="submit">Create Content</button>
			</div>
		</div>
	</form>
</div>