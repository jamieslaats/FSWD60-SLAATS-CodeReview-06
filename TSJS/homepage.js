...
var hotspot = /** @class */ (function () {
    function hotspot(image, name, street, city, postCode, telephone) {
        this.image = image;
        this.name = name;
        this.street = street;
        this.city = city;
...
var sights = /** @class */ (function (_super) {
    ...
    function sights(img, name, street, city, postCode, telephone, metro, openTimes, entryCost) {
        var _this = _super.call(this, img, name, street, city, postCode, telephone) || this;
        _this.metro = metro;
